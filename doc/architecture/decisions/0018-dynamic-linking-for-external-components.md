...
Piper is invoked as a subprocess rather than loaded as a shared object.
...
verification checks dynamic dependency metadata and package dependencies. Every
independently deployed component remains replaceable through a stable
shared-library contract.

ADR 0020 supersedes only this record's treatment of deliberately separated
private Rust components. The external and separately released public-component
rules in this record remain in force.
