...
struct ra_radio {
    struct ast_format *linear; /**< Owned 48 kHz signed-linear radio format. */
 ...
 * @param channel Channel configured for 48 kHz signed-linear read/write formats.
 ...
 * audio. The direct signed-linear transport returns one block per received block,
 * including silence.
 */
